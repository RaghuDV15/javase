...
public class SimpleThreads { // Display a message, preceded by // the name of the current thread  
    ...
    private static class MessageLoop implements Runnable {  
	    ...
	    public static void main(String args[]) throws InterruptedException { // Delay, in milliseconds before // we interrupt MessageLoop // thread (default one hour).  
